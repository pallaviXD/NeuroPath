...
for (let i = 65; i <= 90; i++) {
  ...
  // Elegant modern schematic of the ASL letter hand gesture
  // Includes a stylized visual representation of the hand shape + an index circle mapping that letter
  const letterSvg = `
<svg viewBox="0 0 120 160" fill="none" xmlns="http://www.w3.org/2000/svg">
  <defs>
